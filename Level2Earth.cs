...
{
    public partial class Level2Earth : Form
    {
		...
		private void MainTimerEvent(object sender, EventArgs e)
		{
			...
			if (Player.Bounds.IntersectsWith(Rocket.Bounds) && hasRes == true)
			{


				Player.Visible = false;
				Rocket.Visible = false;
				Level3Mars level3 = new Level3Mars();
				level3.Show();
				// Not done!!! this.Close();
